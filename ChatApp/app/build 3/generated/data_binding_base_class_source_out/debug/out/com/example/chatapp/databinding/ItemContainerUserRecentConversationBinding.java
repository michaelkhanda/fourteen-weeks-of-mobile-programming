...
public final class ItemContainerUserRecentConversationBinding implements ViewBinding {
  @NonNull
  ...
  private ItemContainerUserRecentConversationBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ItemContainerUserRecentConversationBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static ItemContainerUserRecentConversationBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.item_container_user_recent_conversation, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemContainerUserRecentConversationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContainerUserRecentConversationBinding((ConstraintLayout) rootView,
          imageProfile, textName, textRecentMessage, viewSupporter);
    }
